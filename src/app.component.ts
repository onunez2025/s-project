        ...
        <aside
          ...
          <div class="p-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-muted-foreground">Gestión de Proyectos</p>
            </div>
          </div>
          ...
          <div class="p-4 border-t border-border">
            <button (click)="dataService.logout()" 
                    class="w-full flex items-center gap-3 px-3 py-2 text-sm font-medium text-red-500 hover:bg-red-500/10 rounded-md transition-colors">
