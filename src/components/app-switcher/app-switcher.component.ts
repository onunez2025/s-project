...
@Component({
  ...
  template: `
    <div class="relative inline-block">
      ...
      <div *ngIf="isOpen()" 
           class="absolute right-0 mt-2 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.4)] z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-300"
           style="width: 432px; background-color: rgba(255, 255, 255, 0.95);">
